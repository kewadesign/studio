...
- Giraffe (G): Moves max 2 squares (orthogonally). Cannot jump. Cannot enter Sumpf (S) squares. CAN enter Hügel (H) squares.
...
4. A move that sets up a strong offensive or defensive position, considering terrain. Landing on a Kluft (K) can be risky or advantageous. Avoid moving Lions/Gazelles onto Sumpf (S) if other good moves exist, due to the pause. Giraffes can use Hügel (H) squares normally.
